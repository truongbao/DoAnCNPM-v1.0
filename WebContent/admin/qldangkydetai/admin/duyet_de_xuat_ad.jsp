			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<div class="col-md-12">
							<form
								action="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad"
								method="get">
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											<input type="submit" name="search" value="Tìm kiếm"
												class="btn btn-primary btn-search" /> <input type="submit"
												name="cancel" value="Hủy tìm kiếm"
												class="btn btn-primary btn-cancel-search" />
										</div>
									</div>
								</div>
						...
						<table class="table table-striped" id="table-contain">
							...
							<tbody>
								...
								<tr>
									...
									<td><a
										href="<%=request.getContextPath()%>/admin/qldangkydetai/admin/detail_duyet_dx_ad?did=<%=objDeTai.getIdDeTai()%>"><%=objDeTai.getTenDeTai() %></a></td>
							...
							<ul class="pagination">
								<li>
									<%
										 ...
										 %> <a
									href="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad?page=<%=current_page-1%>">Back</a>
									<%} %> <%
										 ...
										 %> <a <%=active %>
									href="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad?page=<%=i%>"><%=i %></a>

									<%}//for %> <%
										    //nếu curren_Page  <sumPage và sumPage > 1 thì thêm Next
										    if(current_page < sumPage && sumPage > 1){
										  %> <a
									href="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad?page=<%=current_page+1%>">Next</a>
