                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <div class="col-md-12">
                                    <form action="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad" method="get">
                                    	<div class="row">
								    ...
								    <ul class="pagination">
								       <li>
								    	<%
										 ...
										 %>  
										   <a href="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad?page=<%=current_page-1%>">Back</a> 
										 <%} %>  	
										 ...
										 %>   	
										   <a <%=active %> href="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad?page=<%=i%>"><%=i %></a>
										  ...
										  %>
										 	 ...
										 	 <a href="<%=request.getContextPath() %>/admin/qldangkydetai/admin/duyet_de_xuat_ad?page=<%=current_page+1%>">Next</a> 
