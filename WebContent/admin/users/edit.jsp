		                         ...
		                         <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Họ tên</label>
                                                <input type="text" name="fullname" class="form-control border-input" placeholder="Họ tên" value="Nguyễn Gia Huy">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type='text' name="namSinh"  class="form-control border-input" data-format="yyyy-MM-dd" id="datetimepicker" value="12/01/1990" /><span class="glyphicon glyphicon-calendar form-control-feedback" style="font-size: 20px;"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" name="email" class="form-control border-input" placeholder=" yourmail@gmail.com" value="anhhuygmail.com" style="height: 62px!important" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dienThoaiCoQuan" class="form-control border-input" placeholder="Số điện thoại" value="0977 665 554">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Đi động</label>
                                                <input type="text" name="diDong" class="form-control border-input" placeholder="Số điện thoại" value="0127 665 772">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Tên tài khoản</label>
                                                <input type="text" name="taiKhoan" class="form-control border-input" value="anhuy" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Mật khẩu</label>
                                                <input type="text" name="matKhau" class="form-control border-input" placeholder="Nhập nếu muốn thay đổi">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
