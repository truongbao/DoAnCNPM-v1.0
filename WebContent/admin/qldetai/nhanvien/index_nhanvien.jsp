			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						...
						<form
							action="<%=request.getContextPath()%>/admin/qldetai/index_nhanvien?type=search"
							method="post">
							<div class="row">
								<div class="col-md-8">
						...
						<div class="row">
							<div class="col-md-8">
								...
								<a class="btn btn-info btn-fill btn-wd"
									...
									href="<%=request.getContextPath()%>/admin/qldetai/duyet_nghiem_thu_nv?type=load">Xem
									danh sách duyệt nghiệm thu</a>
								<%
									} else if (isAdmin) {
								%>
								<a class="btn btn-info btn-fill btn-wd"
									style="margin-top: 20px;"
									href="<%=request.getContextPath()%>/admin/qldetai/duyet_nghiem_thu_ad?type=load">Xem
									danh sách duyệt nghiệm thu</a>
								<%
									}
								%>
						...
						<%
							if (request.getParameter("msg") != null) {
								...
								case 1:
									...
									break;
								case 0:
									out.print("Không thành công vui lòng thử lại !!");
									break;
								}
							}
						%>
						...
						<table class="table table-striped" id="table-contain">
							...
							<tbody>
								...
								<tr>
									...
									<td><a
										href="<%=request.getContextPath()%>/admin/qldangkydetai/xem_de_tai?did=<%=objDeTai.getIdDeTai()%>"><%=objDeTai.getTenDeTai()%></a></td>
 ...
 %>
						...
						<div class="text-right pagination-div">
							<ul class="pagination">
								...
								%>
								<li><a <%=active%>
									href="<%=request.getContextPath()%>/admin/qldetai/index_nhanvien?type=<%=type%>&page=<%=i%>"><%=i%></a>
								<li>
									<%
										}
