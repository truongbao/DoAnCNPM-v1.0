                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row"> 
                            		...
                            		<div class="col-md-8"><a class="btn btn-info btn-fill btn-wd" style = "margin-top: 20px;" href="<%=request.getContextPath()%>/admin/qldetai/admin/duyet_nghiem_thu_ad">Xem danh sách duyệt kết quả nghiệm thu</a>
                            		</div>
