...
<script type="text/javascript">
	function validateForm() {
	    ...
	    var d = document.forms["searchform"]["faculty"].value;
	    if (a == 0 && b == 0 && c == 0 && d == 0 ) {
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<form action="<%=request.getContextPath()%>/admin/general-statistical?type=search" method="post" name="searchform" onsubmit="return validateForm()">
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-4">
									<div class="form-group">
										<select name="faculty" id="faculty"
											...
											<% 
												ArrayList<Khoa> alFaculty = (ArrayList<Khoa>) request.getAttribute("list_Faculty");
												for(Khoa obj: alFaculty){
											%>
											<option value="<%=obj.getIdKhoa()%>"><%=obj.getTenKhoa() %></option>
											<%} %>
										</select>
									</div>
								</div>
						...
						<div class="filter-div">
							...
							<%
									...
									Khoa filter_faculty = (Khoa) request.getAttribute("filter_faculty");
									if(filter_year != 0){
							%>
							...
							<%	} 
								if(filter_faculty != null){
							%>
								<span><%=filter_faculty.getTenKhoa() %></span>	
							<%	}}
							%>							
						</div>  
					</div>
